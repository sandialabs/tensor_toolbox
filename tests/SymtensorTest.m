classdef SymtensorTest < matlab.unittest.TestCase
%SYMTENSORTEST tests the 'symtensor' class in the Tensor Toolbox.
% 
%   Examples:
%
%   res=run(SymtensorTest);
%   table(res)
%
%   % --- OR ---
%
%   run(SymtensorTest,'GenConstructor')
